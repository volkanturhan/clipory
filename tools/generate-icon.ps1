# Generates ClipStack's application icon: an indigo rounded square with a small
...
#
# Run from anywhere; it writes ../ClipStack/Assets/ClipStack.ico.
...
$target = Join-Path $PSScriptRoot '..\ClipStack\Assets\ClipStack.ico'
