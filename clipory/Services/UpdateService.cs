...
/// <summary>
/// Checks GitHub Releases for a newer clipory and, when the user asks for it,
...
/// clipory should never nag, block startup, or break because GitHub happened to
/// be unreachable.
/// </summary>
public sealed class UpdateService
{
    ...
    private const string LatestReleaseApi =
        "https://api.github.com/repos/volkanturhan/clipory/releases/latest";
    ...
    /// then quit clipory so the installer can replace the running files. Throws
    ...
    // (e.g. clipory-setup-v1.1.0.exe), as opposed to the portable exe.
